    ...
    <div class="row justify-content-center">
        <div class="col col-md-6 card mt-5 p-3">
            <form method="post" action="upload" enctype="multipart/form-data">
                <!-- Add the enctype attribute to support file uploads -->

                <div class="form-group">
                    <label for="name">File Name</label>
                    <input name="name" placeholder="This name will be used to save the file after uploading to the server" id="name" type="text" class="form-control">
                </div>
                <div class="form-group">
                    <div class="custom-file">
                        <input type="file" class="custom-file-input" id="document" name="document">
                        <!-- Add name="document" for file input -->
                        <label class="custom-file-label" for="document">Choose file</label>
                    </div>
                </div>
                <div class="form-group custom-control custom-checkbox">
                    <input type="checkbox" class="custom-control-input" id="override" name="override">
                    <!-- Add name="override" for the checkbox -->
